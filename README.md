# tachometer [![Build status](https://travis-ci.org/PolymerLabs/tachometer.svg?branch=master)](https://travis-ci.org/PolymerLabs/tachometer) [![NPM  package](https://img.shields.io/npm/v/tachometer.svg)](https://npmjs.org/package/tachometer)
...
`--browser` / `-b`        | `chrome`    | Which browsers to launch in automatic mode, comma-delimited (chrome, chrome-headless, firefox, firefox-headless)
